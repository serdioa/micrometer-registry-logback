//
// Copied from spring-boot keeping license and attributions.
// This class has no dependencies on spring-boot proper, and may be used in a plain-vanilla Spring applications.
//
 ...
 * {@link ConstructorBinding @ConstructorBinding} is in use, by binding to the constructor parameters.
 * <p>
...
public @interface ConfigurationProperties {
    ...
    /**
     * The prefix of the properties that are valid to bind to this object. Synonym for {@link #prefix()}. A valid prefix
    ...
    /**
     * The prefix of the properties that are valid to bind to this object. Synonym for {@link #value()}. A valid prefix
     * is defined by one or more words separated with dots (e.g. {@code "acme.system.feature"}).
     *
     * @return the prefix of the properties to bind
     */

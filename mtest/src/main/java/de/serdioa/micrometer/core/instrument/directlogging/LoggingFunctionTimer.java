...
/* package private */ class LoggingFunctionTimer<T> extends StepFunctionTimer<T> implements LoggingMeter {
    ...
    protected LoggingFunctionTimer(Id id, Clock clock, long stepMillis, T obj, ToLongFunction<T> countFunction,
